...
def cfg():
    ...
    ## dataset
    dataset = 'SABS'  # i.e. abdominal MRI - 'CHAOST2'; cardiac MRI - CMR
    exclude_label = [1,2,3,6]  # None, for not excluding test labels; Setting 1: None, Setting 2: True
    ...
    eval_fold = 1  # (0-4) for 5-fold cross-validation
    ...
    max_iters_per_load = 100  # epoch size, interval for reloading the dataset
