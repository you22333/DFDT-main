    ...
    def __init__(self, replace_stride_with_dilation=None, pretrained_weights='resnet101'):
        ...
        if pretrained_weights == 'deeplabv3':
            self.pretrained_weights = torch.load(
                r"D:\newbaseline\RPT-main\deeplabv3_resnet101_coco-586e9e4e.pth", map_location='cpu')
        elif pretrained_weights == 'resnet101':
            self.pretrained_weights = torch.load("/home/admin111/UU-base/RPT-main/resnet101-63fe2227.pth",
                                                 map_location='cpu')
        else:
        ...
        self._init_weights()
        # self.pconv = PConv(dim=64, n_div= 3)
        self.convs = nn.Linear(in_features=512, out_features=1024, bias=True)
